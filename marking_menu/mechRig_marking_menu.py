...
def rebuildMarkingMenu(*args):
    ...
    cmds.evalDeferred("""from mechRig_toolkit.marking_menu import mechRig_marking_menu;importlib.reload(mechRig_marking_menu);mechRig_marking_menu.markingMenu()""")
